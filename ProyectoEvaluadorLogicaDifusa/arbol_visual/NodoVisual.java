...
public class NodoVisual implements Serializable
{
    ...
    /**
     * Metodo que cambia el color de relleno del nodo visual.
     * @param colorRelleno Color que se usara como relleno.
     */
    ...
    /**
     * Retorna el Color de usado para el relleno.
     * @return objeto de tipo Color usado para el relleno del nodo visual.
     */
    ...
    /**
     * Metodo que cambia el color del borde del nodo visual.
     * @param colorBorde Color que se usara como borde.
     */
    ...
    /**
     * Retorna el Color de usado para el borde.
     * @return objeto de tipo Color usado para el borde del nodo visual.
     */
    ...
    /**
     * Metodo que cambia el color usado para resaltar un nodo visual seleccionado.
     * @param colorSeleccionado Color que se usara para resaltar un nodo seleccionado.
     */
    ...
    /**
     * Retorna el Color de usado para resaltar un nodo visual seleccionado.
     * @return objeto de tipo Color usado para resaltar un nodo visual seleccionado.
     */
