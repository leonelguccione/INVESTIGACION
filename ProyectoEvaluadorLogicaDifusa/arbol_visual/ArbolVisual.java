...
public class ArbolVisual extends JScrollPane
{
    ...
    private int anchoNodo, altoNodo, separacionHorizontal, separacionVertical, diametroControl, anchoArco, altoArco, anchoBorde;
    ...
    private class Lienzo extends JComponent
    {
        /**
        ...
        public void paint(Graphics g)
        {
            ...
            if (ArbolVisual.this.arbol != null)
            {
                ...
                ArbolVisual.this.dibujaRoundRect(g);
                ...
                } else
                {
                    ...
                    if (nodo != null)
                    {
                        if (nodoSeleccionado != null)
                            hashmap.get(nodoSeleccionado).setSeleccionado(false);
     ...
     * <br><b>Valores por defecto:
     * <br>
     * <br>Colores:</b>
     * <br> Color de fondo: null.
     * <br> Color de lineas: negro.
     * <br> Color de textos: negro.
     * <br> Color de relleno de nodos: gris claro.
     * <br> Color de bordes de nodos: negro.
     * <br> Color para resaltar nodos seleccionados: amarillo.
     * <br> Color de control para expandir y contraer nodos: blanco.
     * <br><b>Gemoetria:</b>
     * <br> Separacion horizontal: 4 pixeles.
     * <br> Separacion vertical de 16 pixeles.
     * <br> Ancho de los nodos visuales: 100 pixeles.
     * <br> Alto de los nodos visuales: 56 pixeles.
     * <br> Ancho de arco de los nodos visuales: 10 pixeles.
     * <br> Alto de arco de los nodos visuales: 10 pixeles.
     * <br> Ancho del borde de los nodos visuales: 2 pixeles.
     * <br> Diametro de control para expandir y contraer nodos: 15 pixeles.
     */
    public ArbolVisual()
    {
        this(null);
    ...
    /**
     * Constructor que crea un arbol visual relaciondolo con un DefaultTreeModel e indicando las medidas de ancho y alto de los nodos visuales<br>
     * <br><b>Valores por defecto:
     * <br>
     * <br> Colores:</b>
     * <br> Color de fondo: null.
     ...
     * @param arbol : el DefaultTreeModel con el que esta relacionado el arbol visual
     * @param anchoNodo : Medida del ancho de los nodos visuales medido en pixeles.
     * @param altoNodo : Medida del alto de los nodos visuales medido en pixeles.
     */
    ...
    /**
     * Meto que dibuja el rectangulo redondeado con relleno de un nodo visual.
     * @param nodoVisual Objeto de tipo NodoVisual que se dibujara.
     * @param g Objeto Graphics donde se dibujaran los rectangulos redondeados.
     */
    protected void dibujaNodoVisual(NodoVisual nodoVisual, Graphics g)
    {
        if (nodoVisual.isSeleccionado())
        {
            ...
            g.fillRoundRect(nodoVisual.getX() + this.anchoBorde, nodoVisual.getY() + this.anchoBorde,
                            this.anchoNodo - this.anchoBorde * 2, this.altoNodo - this.anchoBorde * 2, this.anchoArco,
                            this.altoArco);
            g.setColor(nodoVisual.getColorRelleno());
            g.fillRoundRect(nodoVisual.getX() + this.anchoBorde * 2, nodoVisual.getY() + this.anchoBorde * 2,
                            this.anchoNodo - this.anchoBorde * 4, this.altoNodo - this.anchoBorde * 4, this.anchoArco,
                            this.altoArco);
    ...
    /**
     * Metodo que dibuja los rectangulos redondeados en un Objeto Graphics
     * @param g Objeto Graphics donde se dibujaran los rectangulos redondeados.
     */
    private void dibujaRoundRect(Graphics g)
    {
        ...
        while (nodosVisuales.hasNext())
        {
            ...
            if (nodovisualactual.isVisible())
            {
                ...
                {
                    this.dibujaControlNodo(nodovisualactual, g);
                }
            }
        }
    }
    ...
    /**
     * Metodo que dibuja los controles de expansion / contraccion de un nodo visual
     * @param nodoVisual Nodo Visual al cual se le dibujara su control correpsondiente de acuerdo a si esta expandido o no.
     * @param g Objeto Graphics donde se dibujaran los controles correspondientes.
     */
    protected void dibujaControlNodo(NodoVisual nodoVisual, Graphics g)
    {
    ...
    private void dibujaLineas(Graphics g, DefaultMutableTreeNode nodo)
    {
        ...
        if (nodoVisualPadre.isExpandido())
        {
            ...
            while (hijos.hasMoreElements())
            {
                ...
                if (this.hashmap.get(hijo).isExpandido())
                    dibujaLineas(g, hijo);
            }
        }
    }
    ...
    private void expandeNodo(DefaultMutableTreeNode nodo)
    {
        ...
        {
            DefaultMutableTreeNode hijo = (DefaultMutableTreeNode) hijos.nextElement();
            this.hashmap.get(hijo).setVisible(true);
        }
    }
    ...
    {
        if (nodo.isNodeDescendant(this.nodoSeleccionado))
        {
            hashmap.get(nodoSeleccionado).setSeleccionado(false);
            hashmap.get(nodo).setSeleccionado(true);
    ...
    private void calcularCoordenadas(DefaultMutableTreeNode nodo, int desplazamientoX)
    {
        ...
        if (!nodo.isLeaf())
        {
            ...
            while (hijos.hasMoreElements())
            {
                ...
                desplazamientoAcumulado += this.hashmap.get(hijo).getAnchoreservado();
            }
        }
    }
     ...
     * @param diametroControl cantidad de pixeles que tendra el ancho del control
     */
    ...
    private void calcularDimension()
    {
        int ancho = 0;
        int alto = 0;
        Iterator<NodoVisual> it = this.hashmap.values().iterator();
    ...
    public TreePath getSelectionPath()
    {
        ...
        if (this.nodoSeleccionado != null)
            r = new TreePath(this.nodoSeleccionado.getPath());
        return r;
    }
    ...
    /**
     * Indica el ancho de arco de los nodos visuales.
     * @param anchoArco: ancho de arco de los nodos visuales medido en pixeles
     */
    ...
    /**
     * Retorna el ancho de arco de los nodos visuales.
     * @return ancho de arco de los nodos visuales medido en pixeles
     */
    ...
    /**
     * Indica el alto de arco de los nodos visuales.
     * @param altoArco : alto de arco de los nodos visuales medido en pixeles
     */
    ...
    /**
     * Retorna el alto de arco de los nodos visuales.
     * @return  alto de arco de los nodos visuales.
     */
    ...
    /**
     * Indica el ancho de los bordes de los rectangulos redondeados de los nodos visuales.
     * @param anchoBorde : ancho de los bordes de los rectangulos redondeados de los nodos visuales medido en pixeles.
     */
    ...
    /**
     * Retorna el ancho de los bordes de los rectangulos redondeados de los nodos visuales.
     * @return : ancho de los bordes de los rectangulos redondeados de los nodos visuales medido en pixeles.
     */
    ...
    /**
     * Metodo para indicar el color de relleno que tendran los nodos visuales.
     * @param colorRelleno Objeto de tipo Color para indicar el color de relleno de los nodos visuales
     */
    ...
    /**
     * Retorna el color de relleno de los nodos visuales.
     * @return Objeto de tipo Color para indicar el color de relleno de los nodos visuales.
     */
    ...
    /**
     * Metodo para indicar el color de borde que tendran los nodos visuales.
     * @param colorBorde Objeto de tipo Color para indicar el color de borde de los nodos visuales
     */
    ...
    /**
     * Retorna el color de borde de los nodos visuales.
     * @return Objeto de tipo Color para indicar el color de borde de los nodos visuales.
     */
    ...
    /**
     * Metodo para indicar el color para resaltar un nodo visual seleccionado.
     * @param colorSeleccionado Objeto de tipo Color para indicar el color para resaltar un nodo visual seleccionado.
     */
    ...
    /**
     * Retorna el color para resaltar un nodo visual seleccionado.
     * @return Objeto de tipo Color para indicar el color para resaltar un nodo visual seleccionado.
     */
    ...
    /**
     * Metodo para indicar el color de relleno de los controles para expandir o contraer un nodo visual.
     * @param colorControl Objeto de tipo Color para indicar el color de relleno de los controles para expandir o contraer un nodo visual.
     */
    ...
    /**
     * Retorna el color de relleno de los controles para expandir o contraer un nodo visual.
     * @return Objeto de tipo Color para indicar el color para resaltar un nodo visual seleccionado.
     */
